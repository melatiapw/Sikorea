                               ...
                               @endif
                                ...
                                <form method="post" action="{{route('jenis_pakaian.update', $jenis_pakaian->id)}}">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    <label>Harga</label>
                                                    <input type="number" class="form-control" name="harga" value="<?php echo $jenis_pakaian->harga ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        ...
                                        <button type="button" onclick="window.location='{{ route('katalog', $jenis_pakaian->id) }}'" class="btn btn-inverse">Cancel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
