        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <select name="jenis_pakaian" class="form-control-sm form-control" id="jenis_pakaian">
            ...
            <div class="form-group row">
                ...
                <select name="model" class="form-control-sm form-control" id="model">
            ...
            <div class="form-group row">
                ...
                <select name="bahan" class="form-control-sm form-control" id="bahan">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-12">
                  ...
                  <select name="warna_bahan" class="form-control-sm form-control" id="warna_bahan">
            ...
            <label for="c_fname" class="text-black">Lengan dan Manset</label>
                <div class="col-md-12">
                  ...
                  <select name="lengan" class="form-control-sm form-control" id="lengan">
                ...
                <div class="col-md-12">
                  ...
                  <select name="manset" class="form-control-sm form-control" id="manset">
            ...
            <label for="c_fname" class="text-black">Sablon</label>
              <div class="col-md-12">
                ...
                <select name="sablon" class="form-control-sm form-control" id="sablon">
              ...
              <div class="col-md-12">
                ...
                <select name="lokasi_sablon" class="form-control-sm form-control" id="lokasi_sablon">
              ...
              <div class="col-md-12">
                ...
                <select name="warna_sablon" class="form-control-sm form-control" id="warna_sablon">
            ...
            <div class="form-group row">
                ...
                <select name="lokasi_bordir" class="form-control-sm form-control" id="lokasi_bordir">
            ...
            <div class="form-group row">
                ...
                <select name="jenis_ukuran" class="form-control-sm form-control" id="jenis_ukuran">
            ...
            <div class="form-group row {{ !$errors->has('file') ?: 'has-error' }}">
                ...
                <input type="file" class="form-control" id="c_fname" name="file">
            </div>
